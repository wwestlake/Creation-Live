...
Creation Live is the streaming and broadcast-control sibling in the Creation suite: a JUCE-based control surface for scenes, cue stacks, media playback, overlays, switching, and future language-driven live production workflows.
...
That lets Creation Live share the already-built Windows LLVM install on this machine while still supporting its own manifest-local install later.
