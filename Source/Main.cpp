...
class CreationLiveApplication final : public creation::ui::SuiteJUCEApplication
{
public:
    CreationLiveApplication() : SuiteJUCEApplication(creation::ui::SuiteLogoId::live) {}
...
START_JUCE_APPLICATION(CreationLiveApplication)
